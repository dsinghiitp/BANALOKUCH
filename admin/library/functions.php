...
function buildCategoryOptions($catId = 0)
{
	...
	while($row = dbFetchArray($result)) {
		list($id, $parentId, $name) = $row;
			...
			// the child categories are put in the parent category's array
                        $categories[$parentId][]= array('id' => $id, 'name' => $name);
	}	
	
	// build combo box options
	
        $list=yoyo($categories,0,$catId,"");
        return $list;
}
...
*/
/*
function buildCategoryOptions2($catId = 0)
{
	$sql = "SELECT cat_id, cat_parent_id, cat_name
			FROM tbl_category
			ORDER BY cat_id";
...
/*
function buildCategoryOptions3($catId = 0)
{
	$sql = "SELECT cat_id, cat_parent_id, cat_name
			FROM tbl_category
			ORDER BY cat_id";
...
*/
function createThumbnail($srcFile, $destFile, $height, $quality = 75)
{
	$thumbnail = '';
...
function createThumbnail_dhiru($srcFile, $destFile, $width, $quality = 75)
{
	$thumbnail = '';
