...
<form action="processProduct.php?action=modifyThumb" method="post"  name="frmListProduct2" id="frmListProduct2">
<table>
    <tr>
        <td  align="left"><input name="btnModifyThumb" type="submit" id="btnModifyThumb" value="Modify all thumbnails(change value in function)" class="box" onClick="modifythumbnails()"></td>
    </tr>
</table>
</form>